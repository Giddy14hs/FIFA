      ...
      <section id="us" class="py-5">
            <div class="container">
              ...
              <h1 class="text-center">About Us</h1>
                ...
                <div class="col-md-12 text-center">
                  <h3 className="animate__animated animate__fadeInDown animate__delay-1s">Our Impact</h3>
          ...
          <div className="values container">
            <div className="ui grid row mt-5">
              <h1 className="core text-center py-3 mb-5 animate__animated animate__fadeInDown animate__delay-1s" >Core Values</h1>
          ...
          <section id="mission">
            <div class="container-fluid mx-auto">
                <div  class="mission text-center">
                  <h1 className="animate__animated animate__zoomIn">Our Mission</h1>
                  <p className="animate__animated animate__zoomIn">To   provide micro, small and medium entrepreneurs with the wherewithal to manage their financial resources efficiently through economic empowerment, capacity building and business Advisory services so as to improve the quality of their lives.</p>
                </div>
            </div>
          </section>
          ...
          <section id="vision">
            <div class="container-fluid text-center">
              <h1 class="vision text-center animate__animated animate__fadeInDown animate__delay-2s">Our Vision</h1>
              <p className="animate__animated animate__zoomIn">To empower the entrepreneurs to take greater control of their business by increasing opportunities for making productive and informed economic investments.</p>
            </div>
          </section>
          ...
          <section>
            <div class="container">
              <div class="row">
                <h1 className="animate__animated animate__fadeInDown animate__delay-2s">DIRECTORS</h1>
