        ...
        <div className="row">
            ...
            <div className="imageContainer">
              ...
              <div className="imgOverlay pb-3">
                <div className="imgText">
                  ...
                  <a href="#business">
                      <button type="button" name="button" className="btn btn-outline-warning px-3" onClick={() => navigate('/products/businessLoans')}>Read More</button>
                    </a>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 pb-5">
            <div className="imageContainer">
              ...
              <div className="imgOverlay pb-3">
                <div className="imgText">
                  <h4>Msingi Loans(Business Start-up Loans)</h4>
                  ...
                  <button type="button" name="button" className="btn btn-outline-warning px-3" onClick={() => navigate('/products/msingiLoans')}>Read More</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="imageContainer">
              ...
              <div className="imgOverlay pb-3">
                <div className="imgText">
                  ...
                  <button type="button" name="button" className="btn btn-outline-warning px-3" onClick={() => navigate('/products/salariedLoans')}>Read More</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="imageContainer">
              ...
              <div className="imgOverlay pb-3">
                <div className="imgText">
                  ...
                  <button type="button" name="button" className="btn btn-outline-warning px-3" onClick={() => navigate('/products/groupLoans')}>Read More</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="imageContainer">
              ...
              <div className="imgOverlay pb-3">
                <div className="imgText">
                  ...
                  <button type="button" name="button" className="btn btn-outline-warning px-3" onClick={() => navigate('/products/individualLoans')}>Read More</button>
                </div>
              </div>
               </div>
          </div>
            ...
            <div className="imageContainer">
              ...
              <div className="imgOverlay">
                <div className="imgText">
                  ...
                  <button type="button" name="button" className="btn btn-outline-warning px-3" onClick={() => navigate('/products/specialLoans')}>Read More</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-md-6 pb-3">
            <div className="card-img">
              ...
              <button type="button" name="button" className="btn btn-outline-warning px-3" onClick={() => navigate('/products/savingsplan')}>Read More</button>
              </div>
            </div>
          </div>
          <div className="col-md-6 pb-3">
            <div className="card-img">
              ...
              <button type="button" name="button" className="btn btn-outline-warning px-3" onClick={() => navigate('/products/benevolentfund')}>Read More</button>
              </div>
            </div>
          </div>
        </div>
